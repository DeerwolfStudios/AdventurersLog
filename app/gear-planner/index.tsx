...
const styles = StyleSheet.create({
  ...
  screenSubtitle: { fontFamily: theme.fonts.display, fontSize: moderateScale(14), color: theme.colors.parchmentDim, fontStyle: 'italic', letterSpacing: 1 },
  ...
  createButtonText: { fontFamily: theme.fonts.display, fontSize: moderateScale(20), color: theme.colors.background, fontWeight: 'bold', letterSpacing: 1 },
  emptyState: { alignItems: 'center', paddingVertical: 40, gap: 10 },
  emptyStateIcon: { width: scale(30), height: scale(30) },
  emptyText: { fontFamily: theme.fonts.display, fontSize: moderateScale(30), color: theme.colors.parchmentDim },
  emptySubtext: { fontFamily: theme.fonts.display, fontSize: moderateScale(18), color: theme.colors.textMuted, textAlign: 'center', lineHeight: moderateScale(24), paddingHorizontal: 20 },
  loadoutList: { gap: 10 },
  ...
  loadoutStyleIcon: { width: scale(25), height: scale(25) },
  loadoutName: { fontFamily: theme.fonts.display, fontSize: moderateScale(20), color: theme.colors.parchment, letterSpacing: 0.5 },
  loadoutMeta: { fontFamily: theme.fonts.display, fontSize: moderateScale(19), color: theme.colors.textMuted, marginTop: 2 },
  loadoutCardRight: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  loadoutArrow: { fontFamily: theme.fonts.display, fontSize: moderateScale(28), color: theme.colors.gold },
  deleteBtn: { padding: 4 },
  deleteBtnText: { fontFamily: theme.fonts.display, fontSize: moderateScale(14), color: theme.colors.redLight },
  ...
  modalLabel: { fontFamily: theme.fonts.display, fontSize: moderateScale(15), color: theme.colors.parchmentDark, letterSpacing: 1, textTransform: 'uppercase' },
  input: { borderWidth: 1.5, borderColor: theme.colors.border, borderRadius: 5, backgroundColor: theme.colors.background, paddingHorizontal: 12, paddingVertical: 11, fontFamily: theme.fonts.display, fontSize: moderateScale(15), color: theme.colors.parchment },
  ...
  styleChipIcon: { width: scale(19), height: scale(19) },
  styleChipText: { fontFamily: theme.fonts.display, fontSize: moderateScale(15), color: theme.colors.parchmentDim },
  ...
  cancelBtnText: { fontFamily: theme.fonts.display, fontSize: moderateScale(17), color: theme.colors.parchmentDim },
  primaryBtn: { flex: 1, backgroundColor: theme.colors.gold, borderRadius: 5, paddingVertical: 12, alignItems: 'center' },
  primaryBtnText: { fontFamily: theme.fonts.display, fontSize: moderateScale(17), color: theme.colors.background, fontWeight: 'bold' },
});